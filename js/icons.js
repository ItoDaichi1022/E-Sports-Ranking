...
const PATHS = {
  ...
  // 新しく作る（＋）。丸い枠は置いた側のCSSが描くので、ここは十字だけ持つ
  plus: 'M12 5v14 M5 12h14',
  // 共有（外へ持ち出す矢印）。箱から上向きに出ていく形は、スマートフォンの
  // 共有シートと同じ絵なので、文字が無くても何のボタンか伝わる。
  share: 'M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8 M16 6l-4-4-4 4 M12 2v13',
  // 設定・管理（歯車）。他のアイコンより線が多いが、ここだけは崩すと歯車に
  // 見えなくなる ── 「押すと管理の操作が出る」が絵だけで伝わるのは、この形が
  // どのアプリでも同じ意味で使われているから。
